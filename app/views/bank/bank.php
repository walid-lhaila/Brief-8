        ...
        <tbody class="text-black dark:bg-gray-200">
          <?php foreach ($banks as $bank): ?>
            <tr>
              ...
              <a href="editBank.php?id=<?=$user['id'];?>"><svg class="w-[28px] h-[28px] text-gray-600 hover:text-blue-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
